    ...
    return (
        <>
            <div className="dashboard-container">
                <div style={{ position: 'relative', backgroundColor: '#f9f9f9', color: '#333', minHeight: '100vh', padding: '20px', fontFamily: 'Roboto, sans-serif' }}>
                    <Flex justifyContent="space-between" mb={3}>
                        <InputGroup mb={3} width={{ base: '100%', sm: '300px' }} borderColor="#ccc" borderWidth="1px" borderRadius="md">
                    ...
                    <Box border="1px solid #ccc" borderRadius="md" p={3} mb={3} overflowX="auto">
                    ...
                    <Flex justify="flex-end" align="center" position="absolute" bottom="0" right="0" p={4}>
                        <Box p={4} color="#777" fontWeight="bold" justify="flex-start" display={{ base: 'none', sm: 'block' }}>
